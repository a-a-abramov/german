...
with open('/Users/andrey/anki/groundwork/b_final_topics.pkl', 'rb') as f:
    FINAL = pickle.load(f)
...
insert_after(komm, 'sich bedanken', ['bitte', 'bitten', 'die Bitte', 'danke', 'danken', 'dankbar', 'der Dank'])
...
with open('/Users/andrey/anki/groundwork/b_final_topics2.pkl', 'wb') as f:
    pickle.dump({'FINAL': FINAL, 'FINAL_SUBGROUPS': FINAL_SUBGROUPS}, f)
print("saved b_final_topics2.pkl")
