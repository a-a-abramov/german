...
142 target words grouped **by situation** into 11 scenes (10–15 words each). This replaces
...
- **Words (14):** die Wohnung, das Apartment, wohnen, zentral, das Zentrum, der Raum, das Zimmer, die Etage, der Stock, das Stockwerk, der Aufzug, der Hausmeister / die Hausmeisterin, möbliert, die Einrichtung
...
- **Words (12):** der Umzug, umziehen, packen, die Schachtel, das Tor, der Zugang, der Eingang, die Treppe, das Treppenhaus, der Korridor, der Flur, die Halle
...
- **Words (13):** der Schlüssel, das Schloss, die Tür, öffnen, das Schild, der Balkon, die Terrasse, der Zettel, der Stift, der Kugelschreiber, der Kuli, das Blatt, das Papier
...
- **Words (13):** der Sessel, das Sofa, die Couch, das Kissen, der Teppich, die Lampe, das Licht, ausmachen, die Kerze, das Streichholz, die Vase, das Wohnzimmer, die Tafel
...
- **Words (15):** die Küche, der Herd, derOfen, der Kühlschrank, der Topf, die Schüssel, das Geschirr, abwaschen, das Messer, der Löffel, das Glas, die Flasche, das Brot, die Dose, die Büchse
...
- **Words (14):** putzen, reinigen, sauber, schmutzig, der Schmutz, der Staub, das Tuch, die Bürste, die Ordnung, ordnen, der Ordner, das Heft, das Lager, die Ecke

### Scene 8 — Der Mülltag
- **Premise:** Bin day: the wrong bin, the wrong day, and a neighbour who knows the rules by heart.
- **Angle:** The bin lorry has already been; the sack now lives in the garage until Thursday.
- **Words (13):** der Müll, die Mülltonne, die Müllabfuhr, der Abfall, der Abfalleimer, der Sack, das Haus, der Haushalt, der Keller, die Garage, die Hütte, der Garten, das Dach

### Scene 9 — Waschtag
- **Premise:** Laundry day in the shared basement machine, plus the pile of things that need mending or the dry cleaner.
- **Angle:** One sock survives every wash alone; the doll goes through the machine by accident and comes out fine.
- **Words (12):** die Wäsche, das Waschmittel, die Reinigung, die Socke, die Nadel, nähen, die Schere, die Garderobe, sich umziehen, der Schirm, die Puppe, das Wasser

### Scene 10 — Die kalte Wohnung
- **Premise:** The heating dies in November; the only warm option is a bath, and the bathroom is occupied.
- **Angle:** They end up sleeping in coats under three blankets and calling it cosy.
- **Words (11):** das Bad, die Badewanne, baden, besetzen, die Heizung, heizen, die Zahnbürste, das Bett, der Schlaf, schlafen, die Decke
...
- **Angle:** At six in the morning the site starts working — and the last guests applaud.
- **Words (10):** die Bar, das Zuhause, das Heim, das Fenster, die Scheibe, außen, der Bau, bauen, die Baustelle, die Uhr

---

**Which text owns a word (for card-cutting): this file.** The ledger's `uses.text_no`
records where `vocab.py scan` *first saw* a word, which is not the same thing — 10 of the
142 appear incidentally in an earlier dialogue before the scene that owns them:

| word | first seen | owned by |
|---|---:|---:|
| die Tür | Text 2 | Scene 3 |
...
Each of the ten also appears in its own scene's dialogue, so every cloze can still be cut
verbatim from the owning text. Incidental earlier hits are a bonus, not a reassignment.
